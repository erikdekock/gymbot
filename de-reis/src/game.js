...
const GATE_Z=LEN;       /* visueel eindpunt: positie van het hek in de wereld */
...
function fresh(){return {phase:'start',travel:0,spd:0,air:0,vy:0,duck:false,slapT:0,stun:0,shake:0,flash:0,
 ...
 level:1,capText:'Op weg naar de speeltuin...',fw:[],fwT:0,fwNext:0,retryT:0};}
S=fresh();
...
function update(dt){
 ...
 /* Auto-voltooiing: hek bereikt = etappe gehaald → vuurwerk */
 if(S.travel>=LEN-0.3){S.phase='fireworks';S.fw=[];S.fwT=0;S.fwNext=0;S.shake=0.18;S.cap=0;}
}
