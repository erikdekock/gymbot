...
/**
 * Entry-phase doctrine — L5/L8 Spec §10 (supersedes the §9 FLAG 2
 * "max encoded coverage, latest ordinal" generalisation that 12.3a shipped).
 *
 ...
 *   3. Comeback-arc goals (A1, A5, E7) with comeback persona: entry by
...
function resolvePhase(input, entry) {
  ...
  // Rule 3 — comeback-arc goals (A1, A5, E7) with comeback persona:
  ...
  // Rule 1 — default Phase 1 (incl. A2 comeback, C4, C9, non-comeback on
  //          a comeback-arc goal, any other phased goal at signup).
  return "phase_1";
}
